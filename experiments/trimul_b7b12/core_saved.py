...
def build(kind,fused,cfg):
 ...
 if kind=='front':
  defs=dict(MWK1_CZ=128,MWK1_CH=256,MW_FUSED=int(fused));defs.update(zip(('MWK1_BI','MWK1_BJ','MWK1_NSLOT','MWK1_SKCH','MWK1_SCHED'),cfg));smem=T.front_smem(128,256,cfg)
...
def setup(n):
 from fixture import setup as old
