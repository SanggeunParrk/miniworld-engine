...
def ukernel(count,part=0):
 inc=T._upstream()/'csrc';source=R/'dual_dspref.cu';flags=['-std=c++17','-O3','-arch=sm_90a','--cubin','-lineinfo','-Xptxas=-v','-I'+str(inc),'-DROLE=0',f'-DUCOUNT={count}',f'-DPART_ONLY={part}']
