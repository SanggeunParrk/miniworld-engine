...
// Anthropic v5 TMA/WGMMA primitives; MiniWorld fused B1-B4 training extension.
// Selected experiment: vector FP32 partial stores + cyclic tiles + periodic
// dropout-mask bit reuse. Fusion, forward saves and BF16 rounding unchanged.
// A plan owns one stream/workspace; cooperative grid <= device resident capacity.
// C=128,H=256,L>=64,L*L divisible by64; mask is zero or common positive scale.
// See AUDIT_20260920.md for complete SMEM ownership and measured limitations.
