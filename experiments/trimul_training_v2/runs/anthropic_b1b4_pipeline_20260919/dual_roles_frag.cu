// One variable: keep dnorm and tri in WGMMA fragments through LN backward.
// One variable on cluster_nomc: independent CTA progress, no cluster barriers.
// One variable on dual_cluster: LN epilogue unroll.
