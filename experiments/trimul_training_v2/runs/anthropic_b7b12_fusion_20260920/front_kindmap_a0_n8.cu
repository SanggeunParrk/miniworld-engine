...
TMN_DEVI unsigned logical_block(){unsigned b=blockIdx.x;constexpr unsigned LO=0,HI=UCOUNT-8,N=8;if(b>=LO&&b<LO+N)b+=HI-LO;else if(b>=HI&&b<HI+N)b-=HI-LO;return b;}
struct Params{
