...
TMN_DEVI unsigned logical_block(){unsigned b=blockIdx.x;constexpr unsigned LO=8,HI=UCOUNT-16,N=16;if(b>=LO&&b<LO+N)b+=HI-LO;else if(b>=HI&&b<HI+N)b-=HI-LO;return b;}
struct Params{
