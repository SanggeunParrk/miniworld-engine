...
import argparse
ap=argparse.ArgumentParser();ap.add_argument('--length',type=int,default=384);ap.add_argument('--name',default='candidates');ap.add_argument('sources',nargs='+');args=ap.parse_args()
with torch.no_grad():
