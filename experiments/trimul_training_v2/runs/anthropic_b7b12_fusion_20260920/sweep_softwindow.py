...
with torch.no_grad():
 ...
 for src in ['front_twocta_kindwg', 'front_softw64_g1', 'front_softw64_g2', 'front_softw128_g1', 'front_softw128_g2', 'front_softw256_g1', 'front_softw256_g2', 'front_softw512_g1', 'front_softw512_g2', 'front_softw1024_g1', 'front_softw1024_g2']:
  try:
 ...
 (R/'softwindow-sweep-L768.json').write_text(json.dumps(rec,indent=2));print('RESULT',{k:(v.get('time') or {}).get('median_us',v['status']) for k,v in rec.items()},flush=True)
