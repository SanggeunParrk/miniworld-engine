...
for scope in ('training','training_forward','inference'):
 ...
 for name in names:
  set_backend(name);fn=(latest_train if scope=='training' else latest_training_forward if scope=='training_forward' else latest_inference) if name in ('latest_trimul_only','latest_all') else (old_train if scope=='training' else old_training_forward if scope=='training_forward' else old_inference)
