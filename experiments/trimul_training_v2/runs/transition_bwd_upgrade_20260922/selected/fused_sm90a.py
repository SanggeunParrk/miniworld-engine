...
def _ext(ctas: int, dw_repl: int, save: bool):
    ...
    return load_extension(
        name=f"transition_bwd_upgrade_sm90a_c{ctas}_r{dw_repl}_s{int(save)}",
...
@opaque(fake=_fwd_launch_fake, name="transition_upgrade_fwd_sm90a")
...
@opaque(fake=_bwd_launch_fake, name="transition_upgrade_bwd_sm90a")
