...
ap=argparse.ArgumentParser();ap.add_argument('--length',type=int,default=384);ap.add_argument('--clusters',type=int,default=16);ap.add_argument('--diagnostic-timing',action='store_true');ap.add_argument('--profile',action='store_true');args=ap.parse_args();n=args.length
with torch.no_grad():
