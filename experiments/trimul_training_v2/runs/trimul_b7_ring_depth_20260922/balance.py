...
p=argparse.ArgumentParser();p.add_argument('--configs',default='10:10:32,10:10:48,10:10:64,9:13:64,11:8:64');p.add_argument('--cases',type=int,default=5);args=p.parse_args()
...
with torch.no_grad():
 ...
 for spec in args.configs.split(','):
  groups,cons,regs=map(int,spec.split(':'))
  os.environ['B7_RING_DEPTH']='12';os.environ['B7_CONSUMERS']=str(cons);os.environ['B7_PRODUCER_REGS']=str(regs)
