...
with torch.no_grad():
 ...
 old=module('audited_ring',R.parent/'trimul_b7_joint_cachelast_20260922/plan.py')
 q=old.Plan(d,dy,dl,dr,dg,xn=refplan.xn,clusters=10);q.mask=refplan.mask;q.bind(dl,dr,dg,dy,xn=refplan.xn);plans['ring_baseline']=q
