...
with torch.no_grad():
 ...
 for spec in args.configs.split(','):
  variant,regs=map(int,spec.split(':'));os.environ['B7_PACK']=str(variant);os.environ['B7_PRODUCER_REGS']=str(regs);os.environ['B7_RING_DEPTH']=str(variant if variant else 12)
