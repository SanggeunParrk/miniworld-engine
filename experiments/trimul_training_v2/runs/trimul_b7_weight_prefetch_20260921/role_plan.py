...
T=P.T
@lru_cache(None)
def build(role,saved,splits,pc=2,dxctas=132,prod=40,cons=232,resident=1,slices=2,skip_restore=0,overlap=0,ln_mode=0,xn_early=0,mask_hoist=0,dw_mask_early=0,weight_prefetch=0):
 if xn_early and not resident:raise ValueError('Early next-xn TMA aliases nonresident LN/residual shared buffers')
...
class Plan:
 def __init__(self,d,dy,dl,dr,dg,xn=None,split=False,splits=4,pc=2,dxctas=132,prod=40,cons=232,resident=1,slices=2,skip_restore=0,overlap=0,ln_mode=0,xn_early=0,mask_hoist=0,dw_mask_early=0,weight_prefetch=0):
