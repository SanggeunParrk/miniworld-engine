...
def main():
 ...
 with torch.no_grad():
  a=Q.setup(n);d=a['d'];models={'baseline':BASE.Training(a),'stats_only':Replacement(a,-1),'xhat_fp32':Replacement(a,1),'xhat_fp16':Replacement(a,2),'xhat_fp16_recover':Replacement(a,3)}
