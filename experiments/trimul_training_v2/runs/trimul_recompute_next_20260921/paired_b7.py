...
if 'B7_REUSE_STATS' not in (R/'b7_warp_specialized.cu').read_text():
 raise SystemExit('B7 candidates were not selected. Active code is the previous implementation. Use the rejected-b7 snapshot in a sibling runs directory to reproduce the experimental comparison; see rejected-b7/README.md.')
