// Selective recomputation: no residual/dropout/y, one normalized-Z load per tile.
...
struct TrainCfg : K3Cfg<MWK3_CZ, MWK3_CH, 0, MWK3_BI, MWK3_BJ, MWK3_NSLOT, MWK3_NACC> {
  ...
  static constexpr int SMEM = K3Cfg<MWK3_CZ, MWK3_CH, 0, MWK3_BI, MWK3_BJ, MWK3_NSLOT, MWK3_NACC>::SMEM + 8 * 2048;
};
template <class G>
...
#pragma unroll
    ...
    // Recreate only projection and sigmoid gate consumed by B1-B4.
...
void mw_recompute_output(__grid_constant__ const tmn::sm90::TrainParams p) {
