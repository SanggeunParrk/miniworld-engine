...
out=[]
configs=[dict(BLOCK_M1=bm,BLOCK_N=128,BLOCK_K=bk,GROUP_M=1,num_warps=bm//16,num_stages=st) for bm,bk,st in itertools.product((64,128),(32,64),(2,3,4))]
for l in (128,384,768):
 ...
 out.append(row)
 Path('/home/psk6950/MiniWorld/runs/trimul_sm90_parity_20260917/dual_bwd/bench.json').write_text(json.dumps(out,indent=2))
