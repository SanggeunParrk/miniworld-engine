...
out=[]
configs=[dict(BLOCK_M1=bm,BLOCK_N=128,BLOCK_K=64,GROUP_M=1,num_warps=nw,num_stages=st) for (bm,nw),st in itertools.product(((64,8),(128,4)),(2,3))]
for l in (128,384,768):
 ...
 out.append(row)
 Path('/home/psk6950/MiniWorld/runs/trimul_sm90_parity_20260917/dual_bwd/warp-bench.json').write_text(json.dumps(out,indent=2))
