// Sweep CUTLASS SM90 TF32 GEMM with EXPLICIT schedule (pingpong/cooperative) + stage counts,
// to match cuBLAS. D = A @ W^T, fp32 in/out, tf32 wgmma. Kernel-only timing via cudaEvents.
...
template<class Tile, class Cluster, class KSched, class ESched, class StageCount>
struct G {
  using Epi = typename cutlass::epilogue::collective::CollectiveBuilder<
      ...
      EC, LC, AL, EC, LC, AL, ESched>::CollectiveOp;
  using Main = typename cutlass::gemm::collective::CollectiveBuilder<
      ...
      StageCount, KSched>::CollectiveOp;
...
template<int N> using SC_=cutlass::gemm::collective::StageCountAuto; // placeholder; use Auto
using SAuto=cutlass::gemm::collective::StageCountAuto;
...
double bench_cfg(torch::Tensor A, torch::Tensor W, int cfg, int warmup, int iters){
  ...
  switch(cfg){
    // pingpong, various tiles/clusters
    case 0: return bench_run<G<Shape<_128,_128,_32>,Shape<_1,_1,_1>,PP,EPP,SAuto>::Gemm>(A,W,D,warmup,iters);
    case 1: return bench_run<G<Shape<_128,_128,_32>,Shape<_2,_1,_1>,PP,EPP,SAuto>::Gemm>(A,W,D,warmup,iters);
    case 2: return bench_run<G<Shape<_128,_128,_32>,Shape<_1,_2,_1>,PP,EPP,SAuto>::Gemm>(A,W,D,warmup,iters);
    case 3: return bench_run<G<Shape<_64,_128,_32>,Shape<_1,_1,_1>,PP,EPP,SAuto>::Gemm>(A,W,D,warmup,iters);
    case 4: return bench_run<G<Shape<_64,_256,_32>,Shape<_1,_1,_1>,PP,EPP,SAuto>::Gemm>(A,W,D,warmup,iters);
    case 5: return bench_run<G<Shape<_128,_256,_32>,Shape<_1,_1,_1>,PP,EPP,SAuto>::Gemm>(A,W,D,warmup,iters);
    // cooperative
    case 6: return bench_run<G<Shape<_128,_128,_32>,Shape<_1,_1,_1>,CO,ECO,SAuto>::Gemm>(A,W,D,warmup,iters);
    case 7: return bench_run<G<Shape<_256,_128,_32>,Shape<_1,_1,_1>,CO,ECO,SAuto>::Gemm>(A,W,D,warmup,iters);
    case 8: return bench_run<G<Shape<_128,_128,_64>,Shape<_1,_1,_1>,CO,ECO,SAuto>::Gemm>(A,W,D,warmup,iters);
    case 9: return bench_run<G<Shape<_64,_128,_32>,Shape<_2,_1,_1>,PP,EPP,SAuto>::Gemm>(A,W,D,warmup,iters);
    default: TORCH_CHECK(false,"bad cfg"); return 0;
  }
}
int n_cfg(){return 10;}
PYBIND11_MODULE(TORCH_EXTENSION_NAME,m){m.def("bench",&bench_cfg);m.def("n_cfg",&n_cfg);}
