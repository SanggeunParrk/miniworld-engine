...
template <
    ...
    class TmaWa,
    class TmaWb>
__global__ __launch_bounds__(kThreads, MW_TRANSITION_MIN_BLOCKS) void transition_expand_gate_rs_wgmma_kernel(
...
torch::Tensor transition_expand_gate_fwd(
    ...
    launch_transition_expand_gate_kernel<MW_TRANSITION_WIDTH, 4 * MW_TRANSITION_WIDTH, kBlockM, kWarpgroupM, MW_TRANSITION_BN, MW_TRANSITION_STAGES, MW_TRANSITION_KT>(
