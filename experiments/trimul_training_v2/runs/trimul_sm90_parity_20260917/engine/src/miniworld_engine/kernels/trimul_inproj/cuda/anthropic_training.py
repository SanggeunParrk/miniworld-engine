...
def _upstream():
    ...
    return configure() / 'common/opt_core/opt_core/kernels/trimul/native/pkg/v5'
...
def build(cz, ch, cfg):
    ...
    root=Path(os.environ.get('MINIWORLD_TRIMUL_TRAIN_BUILD_DIR',str(Path.home()/'.cache/miniworld-engine/anthropic-trimul-training')))
