...
class Settings:
    ...
    #: Fuse squeeze/residual and LN-backward/residual, including qualified Hopper paths.
    transition_residual_fusion: bool = True
    #: Auto-select native Hopper with residual-fused backward; forced Triton policy wins.
    transition_h100_residual: bool = True
    #: Save native b2b's BF16 normalized activation for D128/256 training at M>=16384.
    #: Saves repeated normalization in backward; retains an extra M*D BF16 activation.
    transition_h100_save_xn: bool = True
    #: Shared inference/training segmented b2b forward on measured SM90 D128/256 pair shapes.
    transition_triton_b2b: bool = True
