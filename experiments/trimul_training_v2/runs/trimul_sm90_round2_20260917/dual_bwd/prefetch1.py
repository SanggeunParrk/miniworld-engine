...
class DualBackwardSm90:
    ...
    def kernel(
        ...
        if warp == 0:
            for pre in cutlass.range_constexpr(self.stages, min(2 * self.stages, self.front_tiles)):
...
@opaque(fake=_fake, name="trimul_round2_prefetch1_sm90")
