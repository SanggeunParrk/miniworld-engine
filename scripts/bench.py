# vendored + trimmed from team-gm psk/benchmark : scripts/bench.py
...
@hydra.main(config_path="../config", config_name="bench", version_base=None)
def main(cfg: DictConfig) -> None:
    ...
    # Results live under the repo-level benchmark/ dir (not next to this script).
    results_dir = _REPO_ROOT / "benchmark" / gpu_name
