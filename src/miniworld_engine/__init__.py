"""miniworld-engine — hand-optimized GPU kernels for AF3-style ops.
...
``miniworld_engine.kernels`` is the **primitive** surface (per-GEMM / LN / gate /
...
try:
    __version__ = version("miniworld-engine")
