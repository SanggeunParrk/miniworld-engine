...
forward with a symmetric GEMM backward. :func:`triton_adaptive_layer_norm` is the
original single-autograd-Function kernel both were derived from, kept as the reference
