...
_triangle_attention_perf_fwd_prune = make_cache_prune(
    "triangle_attention_perf_fwd", dtype_of=tensor_dtype_of("q_ptr"),
    bucket_of=key_bucket_of("GROUP_N", "H", "HEAD_DIM"),
)


@triton.autotune(configs=configs, key=["GROUP_N", "H", "HEAD_DIM"],
                 prune_configs_by={"early_config_prune": _triangle_attention_perf_fwd_prune})
@triton.jit
def _attn_fwd(
    q_ptr,
    k_ptr,
...
_triangle_attention_perf_bwd_preprocess_prune = make_cache_prune(
    "triangle_attention_perf_bwd_preprocess", dtype_of=tensor_dtype_of("o"),
    bucket_of=key_bucket_of("GROUP_N", "H", "HEAD_DIM"),
)


@triton.autotune(configs=pre_configs, key=["GROUP_N", "H", "HEAD_DIM"],
                 prune_configs_by={"early_config_prune": _triangle_attention_perf_bwd_preprocess_prune})
@triton.jit
...
_triangle_attention_perf_bwd_prune = make_cache_prune(
    "triangle_attention_perf_bwd", dtype_of=tensor_dtype_of("q_ptr"),
    bucket_of=key_bucket_of("GROUP_N", "H", "HEAD_DIM"),
)
...
@triton.autotune(
    ...
    prune_configs_by={"early_config_prune": _triangle_attention_perf_bwd_prune},
)
@triton.jit
def _attn_bwd(
    q_ptr,
