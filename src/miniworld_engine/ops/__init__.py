...
Contrast with :mod:`miniworld_engine.kernels`, which holds the **primitive** fusion
...
_LAZY_OPS = {
    ...
    "triangle_attention": (
        "miniworld_engine.kernels.triangle_attention.whole_op",
        "triangle_attention",
    ),
    "transition": (
        "miniworld_engine.kernels.transition.whole_op",
        "transition",
    ),
    "conditioned_transition": (
        "miniworld_engine.kernels.conditioned_transition.whole_op",
        "conditioned_transition",
    ),
    "augmented_attention_pair_bias": (
        "miniworld_engine.kernels.augmented_attention.whole_op",
        "augmented_attention_pair_bias",
    ),
    "layer_norm_linear": (
