"""Shared visualization conventions for miniworld-engine benchmarks.
...
paper reviewer) sees this repo's kernels in the same gold colour in every plot, and the
NVIDIA baselines in the same greens, regardless of which figure they look at.

See ``style.py`` for the actual definitions.
"""

from miniworld_engine.viz.style import (
    FORMATS,
    PALETTE,
    apply_theme,
    canonical,
