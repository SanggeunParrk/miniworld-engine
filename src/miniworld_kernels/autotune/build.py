...
def build_trimul_bidir_front(d_pairs=(128, 256, 512), seq_lens=(384,), top_k=5,
...
_BUILDERS = {"trimul_bidir_front": build_trimul_bidir_front}


def main() -> None:
    ap = argparse.ArgumentParser()
    ap.add_argument("--op", default="trimul_bidir_front", choices=sorted(_BUILDERS))
    args = ap.parse_args()
