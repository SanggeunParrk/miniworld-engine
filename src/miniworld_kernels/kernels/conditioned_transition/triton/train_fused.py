...
MEASURED VERDICT (H100, CUDA-graph; benchmark/training_fused_no_cublas.md + the
training_fused_v2 / training_fused_perstage_cudagraph .out logs): CORRECT (all 7 grads +
