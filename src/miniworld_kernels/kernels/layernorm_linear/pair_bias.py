...
@torch.library.custom_op("miniworld_kernels::layer_norm_linear_fwd", mutates_args=())
def _fwd_op(
...
@torch.library.custom_op("miniworld_kernels::layer_norm_linear_bwd", mutates_args=())
def _bwd_op(
    dout: torch.Tensor,
    x2: torch.Tensor,
