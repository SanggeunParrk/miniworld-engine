# vendored from team-gm origin/perf/trimul@3fbb02b : src/team_gm/modules/kernels/tm2.py
import os
...
if AUTOTUNE:
    ...
    fwd_configs = [
        ...
        triton.Config({"BLOCK_M": 16, "BLOCK_K": 64, "BLOCK_N": 64}, 4, 2),
        triton.Config({"BLOCK_M": 32, "BLOCK_K": 64, "BLOCK_N": 64}, 8, 2),
        triton.Config({"BLOCK_M": 64, "BLOCK_K": 32, "BLOCK_N": 128}, 4, 2),
        triton.Config({"BLOCK_M": 16, "BLOCK_K": 32, "BLOCK_N": 64}, 4, 1),
    ]
    bwd_configs = [
        triton.Config({"BLOCK_M": 32, "BLOCK_K": 32, "BLOCK_N": 128}, 4, 1),
        triton.Config({"BLOCK_M": 16, "BLOCK_K": 64, "BLOCK_N": 64}, 4, 2),
...
def fused_sigmoid_gate2_fwd_kernel(
    ...
    for k_start in range(0, N, BLOCK_K):
        ...
        A_tile += tl.dot(x_gate_tile, W_gate_tile, allow_tf32=ALLOW_TF32)
        B_tile += tl.dot(x_out_tile, W_out_tile, allow_tf32=ALLOW_TF32)
