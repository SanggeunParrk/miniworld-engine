r"""Bidirectional TriangleMultiplication bench — team-gm harness format (see BENCHMARKING.md).
...
Sweeps M = L^2 (L = seq_len) × d_pair. ALL COMPILED (BENCHMARKING.md hard rule: the pytorch
