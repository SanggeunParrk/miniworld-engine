...
def test_mpnn_edge_mlp_memory_recompute_drift_stays_bounded() -> None:
    ...
    """
    from miniworld_engine.kernels.mpnn_edge_mlp.triton.main import (
...
def test_mpnn_edge_mlp_forward_saved_tensor_policy(
    ...
    with torch.autograd.graph.saved_tensors_hooks(pack, unpack), torch.autocast("cuda", dtype=torch.bfloat16):
