...
# Launches a kernel (the dropout check does it in a subprocess), so it needs a card.
...
def _reproduce_keep_mask(
    ...
    from miniworld_engine.kernels.mpnn_edge_tail.triton.main import _PHILOX_ROUNDS
...
def test_mpnn_edge_tail_shared_gelu_matches_the_unshared_form_bitwise() -> None:
    ...
    from miniworld_engine.kernels.mpnn_edge_tail.triton.main import (
        _gelu,
        _gelu_erf,
        _gelu_from_erf,
        _gelu_grad,
