...
FUNCS = ("mpnn_relative_position", "mpnn_node_message", "mpnn_edge_tail",
...
ROLES = ("bwd_reduce", "bwd_pre", "reduce", "gelu", "transpose", "epilogue", "layernorm", "sigmoid", "squeeze",
...
DETAILS = ("recompute", "foldstats", "noaffine", "rowscale", "dropres", "inplace", "ktiled",
           "strided", "mmajor", "extern", "packed", "atomic", "contig", "gather", "split", "flat", "fp32",
