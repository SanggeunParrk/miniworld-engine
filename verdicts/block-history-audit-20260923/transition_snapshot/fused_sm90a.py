...
def _ext(ctas: int, dw_repl: int, save: bool):
    ...
    return load_extension(
        name=f"history_transition_fused_sm90a_c{ctas}_r{dw_repl}_s{int(save)}",
...
@opaque(fake=_fwd_launch_fake, name="history_transition_fused_fwd_sm90a")
...
@opaque(fake=_bwd_launch_fake, name="history_transition_fused_bwd_sm90a")
