...
def _forward_fake(leaves, mask, ds):
    ...
    return [
        ...
        x.new_empty((1024, 128) if d == 128 else (0,)),
    ]


@opaque(fake=_forward_fake, name="trimul_h100_train_fwd_prepared")
def forward(
...
@opaque(fake=_backward_fake, name="trimul_h100_train_bwd_prepared")
def backward(
