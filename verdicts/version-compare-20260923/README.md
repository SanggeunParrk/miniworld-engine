...
| OPM | 384 | 0.945 | — | 0.953 | 0.703 |
| OPM | 768 | 3.443 | — | 3.451 | 2.665 |
| PWA | 384 | 1.000 | — | 1.001 | 0.407 |
| PWA | 768 | 2.160 | — | 2.162 | 1.307 |
| MSA module 1블록 | 384 | 4.085 | — | 오류 | 1.640 |
| MSA module 1블록 | 768 | 19.789 | — | 오류 | 5.680 |
...
| OPM | 384 | 2.524 | — | 2.726 | 2.035 |
| OPM | 768 | 9.232 | — | 9.725 | 7.625 |
| PWA | 384 | 2.669 | — | 2.955 | 1.586 |
| PWA | 768 | 5.722 | — | 6.502 | 4.132 |
| MSA module 1블록 | 384 | 11.720 | — | 오류 | 5.894 |
| MSA module 1블록 | 768 | 57.256 | — | 오류 | 19.654 |
...
- MSA module 1블록 inference: triton_poi_fused_bitwise_and_expand_opm_h100_fwd_unsqueeze_0; _opm_prologue_kernel; (anonymous namespace)::opm_epilogue_kernel(__nv_bfloat16 const*, float const*, __nv_bfloat16 const*, float const*, int, int, long, CUtensorMap_st); triton_poi_fused__to_copy_add_bitwise_and_pwa_h100_infer_trimul_h100_infer_unsqueeze_1; void (anonymous namespace)::pwa_fwd2_kernel<3, 1>(int, int, int, int, CUtensorMap_st, CUtensorMap_st, __nv_bfloat16 const*, __nv_bfloat16 const*, float, CUtensorMap_st, CUtensorMap_st, CUtensorMap_st, CUtensorMap_st, CUtensorMap_st); wide_d64_fwd_kernel; triton_poi_fused__to_copy_add_bitwise_and_trimul_h100_infer_unsqueeze_2; tmn_k1_z128_h256_b_t3x64_s8k2_m1_l2_v0; tmn_k3_z128_h256_b_t2x64_s8a1_l1; triton_poi_fused_clone_t_transition_fused_fwd_sm90a_view_3; transition_fwd_fused
- MSA module 1블록 training: triton_poi_fused__to_copy_div_gt_rand_0; triton_poi_fused_clone_t_transition_fused_fwd_sm90a_view_1; triton_poi_fused_bitwise_and_expand_unsqueeze_2; triton_poi_fused__to_copy_bitwise_and_clone_expand_select_unsqueeze_3; _opm_prologue_kernel; (anonymous namespace)::opm_epilogue_kernel(__nv_bfloat16 const*, float const*, __nv_bfloat16 const*, float const*, int, int, long, CUtensorMap_st); triton_poi_fused_add_4; triton_poi_fused_cat_copy__stack_view_0; infer_k1; save_k3; transition_fwd_fused; void (anonymous namespace)::pwa_fwd2_kernel<3, 1>(int, int, int, int, CUtensorMap_st, CUtensorMap_st, __nv_bfloat16 const*, __nv_bfloat16 const*, float, CUtensorMap_st, CUtensorMap_st, CUtensorMap_st, CUtensorMap_st, CUtensorMap_st)
...
- ('msa', 384, 'engine1') inference: `torch._dynamo.exc.InternalTorchDynamoError: AcceleratorError: CUDA error: device-side assert triggered`
- ('msa', 384, 'engine1') training: `torch.AcceleratorError: CUDA error: device-side assert triggered`
- ('msa', 768, 'engine1') inference: `torch._dynamo.exc.InternalTorchDynamoError: AcceleratorError: CUDA error: device-side assert triggered`
- ('msa', 768, 'engine1') training: `torch.AcceleratorError: CUDA error: device-side assert triggered`
